...
public interface Constants {
    ...
    String GREETINGS_TEXT = "Бот приютов для животных г.Нур-Султан приветствует Вас! Выберите, какой приют вас интересует: ";
    ...
    String PHOTO_REPORT_REQUIRED = "Отлично, текст отчета у нас есть. Теперь пришлите фото питомца.\n" +
