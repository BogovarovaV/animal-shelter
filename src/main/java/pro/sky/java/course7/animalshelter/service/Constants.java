...
public interface Constants {
    ...
    String CYNOLOGIST_ADVICE_CMD = "Советы кинолога";
    String CYNOLOGIST_ADVICE_TEXT = "1. Не навязывайте собаке своё общество. Разумеется, необходимо следить за животным и находиться рядом " +
