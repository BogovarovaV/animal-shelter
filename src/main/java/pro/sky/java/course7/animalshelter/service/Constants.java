...
public interface Constants {
    ...
    String BACK_TO_START_CMD = "Главное меню ↩";
    ...
    String HOW_TO_TAKE_CMD = "Как забрать питомца";
    ...
    String COMMON_ADVICE_CMD = "Общие рекомендации";
    ...
    String ADVICE_FOR_SPECIAL_DOG_CMD = "Собака с ОВ";
