...
public interface Constants {
    ...
    String DOG_COMMON_ADVICE_TEXT = "\uD83D\uDFE2 До того, как вы привезете нового члена семьи в дом, позаботьтесь о том, чтобы купить средство от блох и клещей, " +
    ...
    String CAT_TRANSPORTING_TEXT = "\uD83D\uDFE3 Когда вы определились, какого котика хотите забрать домой, купите и принесите переноску с приют заранее. " +
    ...
    String CAT_COMMON_ADVICE_TEXT = "\uD83D\uDFE3 До того, как вы привезете нового члена семьи в дом, позаботьтесь о том, чтобы купить средство от блох и клещей, " +
            "зоошампунь и корм. \n\n\uD83D\uDFE3 До того, как купить еду для питомца, посоветуйтесь с сотрудниками приюта или куратором животного. " +
            "Возможно, у него назначен специализированный корм или имеется аллергия.\n" +
            "\n\uD83D\uDFE3 Также для кошки следует приобрести две миски (для еды и для воды, мисок для воды должно быть несколько " +
    ...
    String ADVICE_FOR_SPECIAL_CAT_TEXT = "\uD83D\uDFE3 Взять из приюта котика с ограниченными возможностями - это серьезное решение. " +
            ...
            "уделять котику больше внимания и заботы. \n Будьте уверены, питомец ответит вам взаимностью.";
    ...
    String FELINOLOGIST_ADVICE_TEXT = "\uD83D\uDFE3 Любая кошка обладает определенным характером. И зачастую его становление зависит от того, " +
            ...
            "\n\uD83D\uDFE3 Ни в коем случае кошку нельзя ругать, бить. Если кошка напакостила или залезла, куда нельзя, не надо сразу бежать к ее сторону, размахиваю руками.\n" +
